...
| Archivo | Tamaño | Uso |
|---------|--------|-----|
| `icon-192-v2.png` | 192×192 | Manifest (`purpose: any`) |
| `icon-512-v2.png` | 512×512 | Manifest (`purpose: any`) |
| `icon-512-maskable-v2.png` | 512×512 | Manifest (`purpose: maskable`); deja ~10% de safe zone |
